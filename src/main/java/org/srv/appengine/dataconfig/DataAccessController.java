package org.srv.appengine.dataconfig;
...
public class DataAccessController {
  ...
  public String fetchAllData() throws IOException {
    ...
    try {
      SearchResponse searchResponse = dataAccessConfiguration.prepareCient()
          .search(dataAccessConfiguration.prepareSearchRequest(), RequestOptions.DEFAULT);
