...
public class _Function {
  ...
  static Function<Integer, Integer> squareIncrement = squareNumberFunction.andThen(
      incrementOnOneFunction);
  //BI-FUNCTIONAL APPROACH [TWO INPUT, ONE OUTPUT]
  static BiFunction<Integer, Integer, Integer> addTwoNumbers = (numOne, numTwo) ->
      incrementOnOneFunction.apply(numOne) + incrementOnOneFunction.apply(numTwo);
  static BiFunction<String, String, String> combineStrings = (source, target) -> joinTwoStrings(
      source, target);
