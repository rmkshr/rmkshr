...
//Jackson is CASE SENSITIVE : case sensitivity between the json and the POJO class MATTERS!
  ...
  public EmployeeJackson readJsonWithObjectMapper() throws IOException {
    ...
    EmployeeJackson employeeJackson = objectMapper.readValue(new File(
            "/Users/ramkishoremadheshwaran/Documents/IntelliJ Workspace/rmkshr/src/main/java/org/srv/jackson/employee.json"),
        EmployeeJackson.class);
