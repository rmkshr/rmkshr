...
public class NewFileMethods {
  ...
  public static void main(String[] args) {
    ...
    try {
      Path pathOne = Files.createTempFile(
          Path.of("/Users/ramkishoremadheshwaran/Local/javatempfiles"), "tempFileOne", ".txt");
      Path pathTwo = Files.createTempFile(
          Path.of("/Users/ramkishoremadheshwaran/Local/javatempfiles"), "tempFileTwo", ".txt");
      ...
      Path pathThree = Files.createTempFile(
          Path.of("/Users/ramkishoremadheshwaran/Local/javatempfiles"), "tempFileThree", ".txt");
      Path pathFour = Files.createTempFile(
          Path.of("/Users/ramkishoremadheshwaran/Local/javatempfiles"), "tempFileFour", ".txt");
