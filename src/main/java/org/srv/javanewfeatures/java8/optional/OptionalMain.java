package org.srv.javanewfeatures.java8.optional;
...
public class OptionalMain {
  ...
  public static void main(String[] args) {
    ...
    String resultOptional = Optional.ofNullable(valueOfString)
        .orElseThrow(() -> new IllegalStateException("")).toUpperCase();
