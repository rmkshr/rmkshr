...
/**
 * @author ramkishore Class to authorize access. Called once per request.
 */
@Slf4j
public class CustomAuthorizationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    if (request.getServletPath().equals("/apiv3/login") || request.getServletPath()
        .equals("/apiv3/refreshtoken")) {
